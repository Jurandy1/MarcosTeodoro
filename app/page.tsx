    ...
    <section className="relative text-white overflow-hidden" style={{ background: '#0b1420' }}>
      ...
      <div className="absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg,rgba(11,20,32,.42) 0%,rgba(11,20,32,.32) 45%,rgba(11,20,32,.88) 100%), linear-gradient(90deg,rgba(11,20,32,.82) 0%,rgba(11,20,32,.22) 55%,rgba(11,20,32,.4) 100%)',
          }}
        />
      ...
      {/* Conteúdo */}
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 grid md:grid-cols-[1.15fr_.85fr] items-center gap-10 py-20 md:py-24">
        {/* Texto */}
        <div>
          <div
            className="anim-1 inline-block text-[#c9a35a] text-[0.68rem] font-semibold tracking-[.24em] uppercase mb-5"
          >
            BC · Itapema · Porto Belo · Bombinhas
          </div>
          <h1
            className="anim-2 text-4xl md:text-[2.6rem] font-medium leading-tight tracking-tight mb-5"
            style={{ fontFamily: 'var(--font-serif)' }}
          >
            Você sabe quem<br />
            <em className="not-italic text-[#c9a35a]">sou eu?</em>
          </h1>
          <p className="anim-3 text-[#c3c6cc] text-[0.95rem] leading-relaxed max-w-[50ch] mb-8">
          ...
          {/* Stats */}
          <div className="anim-4 flex gap-8 flex-wrap">
            {[
              ...
              <div key={i}>
                <div
                  className="text-[1.7rem] text-[#c9a35a] leading-none"
                  style={{ fontFamily: 'var(--font-serif)' }}
                >
                  {s.num}
                  {s.unit && (
                    <span className="text-[1rem] text-[#c9a35a]/80 ml-1">{s.unit}</span>
                  )}
                </div>
                <div className="text-[0.58rem] tracking-[.24em] text-[#8b8f96] uppercase mt-1">
                  {s.label}
                </div>
              </div>
            ))}
        ...
        <div className="flex justify-center">
          <div className="relative w-[min(320px,80vw)]" style={{ aspectRatio: '4/5' }}>
...
function SearchBar() {
  return (
    <div className="-mt-12 relative z-20 px-4">
      <div
        className="max-w-[980px] mx-auto bg-white rounded-2xl shadow-[0_18px_48px_rgba(11,20,32,.14)] border-t-[3px] border-[#c9a35a] p-4"
      >
        <form
          className="grid grid-cols-1 sm:grid-cols-[1fr_1fr_1.4fr_auto] gap-3"
          action="#"
        >
          <div className="flex flex-col gap-1 sm:border-r border-[#e6e2da] sm:pr-3">
            <label className="text-[0.58rem] font-bold tracking-[.18em] uppercase text-[#9a9da2]">
              Tipo de imóvel
            </label>
            <select className="border-0 bg-transparent font-sans text-[0.86rem] text-[#2a3541] outline-none py-1 cursor-pointer">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              type="text"
              placeholder="Balneário Camboriú, Itapema, Porto Belo…"
              className="border-0 bg-transparent font-sans text-[0.86rem] text-[#2a3541] outline-none py-1 placeholder:text-[#b0b5bb]"
            />
          </div>
          <button
            type="submit"
            className="flex items-center justify-center gap-2 bg-[#0e6b7a] text-white rounded-xl px-6 py-2.5 text-[0.7rem] font-bold tracking-[.16em] uppercase transition-all hover:bg-[#095260] w-full sm:w-auto"
          >
            <SearchIcon />
            Buscar
          </button>
...
function CategoriesSection() {
  ...
  return (
    <section className="pt-16 pb-4 overflow-hidden" style={{ background: 'linear-gradient(180deg,#fff 0%,#fbf9f4 100%)' }}>
      <div className="max-w-[1200px] mx-auto px-4 flex justify-between items-end gap-4 flex-wrap mb-8">
        <h2
          className="font-light text-[1.9rem] leading-tight max-w-[20ch] text-[#0b1420]"
          style={{ fontFamily: 'var(--font-serif)' }}
        >
          O que você está<br />
          <em className="text-[#0e6b7a]">procurando?</em>
        </h2>
        <p className="max-w-[36ch] text-[#5a6069] text-[0.88rem] leading-relaxed">
      ...
      <div className="overflow-hidden">
        <div className="flex gap-4" style={{ animation: 'marquee 42s linear infinite', width: 'max-content', padding: '0.5rem 0' }}>
          {cats.map((cat, i) => (
            <Link
              key={i}
              href={cat.href}
              className="flex-none w-[340px] h-[200px] relative rounded-2xl overflow-hidden text-white flex flex-col justify-between p-5 shadow-[0_10px_30px_rgba(11,20,32,.15)] hover:-translate-y-1 transition-transform"
              style={{
            ...
            >
              ...
              <div className="relative">
                <div
                  className="text-[1.9rem] leading-none mb-1"
                  style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic' }}
                >
                  {cat.title}
                </div>
                <div className="text-[0.6rem] tracking-[.24em] uppercase text-white/60">{cat.sub}</div>
              </div>
            </Link>
          ))}
        </div>
...
function FeaturedSection() {
  return (
    <section className="py-12 bg-[#fbf9f4]">
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="flex items-center justify-between gap-4 mb-7">
          <h2
            className="flex items-center gap-3 text-[1.35rem] font-normal text-[#0b1420]"
            style={{ fontFamily: 'var(--font-serif)' }}
          >
            <span className="w-7 h-0.5 bg-[#c9a35a] rounded-full inline-block shrink-0" aria-hidden="true" />
            Imóveis em Destaque
          </h2>
          <Link
            href="/vendas"
            className="text-[0.68rem] font-bold tracking-[.14em] uppercase text-[#0e6b7a] hover:text-[#095260] transition-colors flex items-center gap-1"
          >
            Ver todos &rarr;
          </Link>
        </div>
...
function AboutSection() {
  return (
    <section id="sobre" className="py-16 relative overflow-hidden bg-[#f4f2ee]">
      ...
      <div className="max-w-[1200px] mx-auto px-4 grid md:grid-cols-[360px_1fr] items-center gap-14 relative">
        {/* Foto */}
        <div className="relative mx-auto md:mx-0 w-full max-w-[360px] aspect-[4/5] rounded-lg overflow-hidden shadow-[0_30px_80px_rgba(11,20,32,.15)]">
          <Image
        ...
        {/* Texto */}
        <div>
          <div className="text-[0.64rem] font-semibold tracking-[.22em] uppercase text-[#0e6b7a] mb-3">
            Você sabe quem sou eu?
          </div>
          <h2 className="text-[1.65rem] md:text-[2rem] font-semibold leading-tight text-[#0b1420] mb-5 max-w-[26ch]">
            Sou Marcos Teodoro — administrador, investidor e especialista no litoral de SC
          </h2>
          <p className="text-[#4a5560] text-[0.9rem] leading-relaxed mb-4 max-w-[58ch]">
          ...
          <p className="text-[#4a5560] text-[0.9rem] leading-relaxed mb-7 max-w-[58ch]">
          ...
          {/* Métricas */}
          <div className="grid grid-cols-2 gap-4 max-w-[480px] mb-7">
            {[
...
function IntentSection() {
  return (
    <section className="py-14 bg-[#f4f2ee]">
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="mb-8 text-center max-w-[52ch] mx-auto">
          <h2
            className="text-[1.65rem] font-normal leading-tight text-[#0b1420] mb-2"
            style={{ fontFamily: 'var(--font-serif)' }}
          >
            E você, como posso <em className="text-[#0e6b7a]">te ajudar?</em>
          </h2>
          <p className="text-[0.88rem] text-[#5a6069]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {intentCards.map((card, i) => (
            <a
              key={i}
              href={card.href}
              className="bg-white border border-[#e6e2da] rounded-2xl p-7 hover:shadow-[0_14px_40px_rgba(11,20,32,.1)] hover:-translate-y-1 transition-all flex flex-col gap-5 group"
            >
              <div
...
function PopularSearches() {
  return (
    <section className="py-12 bg-white">
      <div className="max-w-[1200px] mx-auto px-4">
        <h2
          className="flex items-center gap-3 text-[1.35rem] font-normal text-[#0b1420] mb-6"
          style={{ fontFamily: 'var(--font-serif)' }}
        >
          <span className="w-7 h-0.5 bg-[#c9a35a] rounded-full inline-block shrink-0" aria-hidden="true" />
          Buscas populares
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2.5">
          {popularSearches.map((s, i) => (
            <Link
              key={i}
              href="/vendas"
              className="flex justify-between items-center text-[0.78rem] text-[#4a5560] bg-[#f4f2ee] border border-transparent rounded-xl px-4 py-3 hover:border-[#0e6b7a] hover:text-[#0e6b7a] hover:bg-white transition-all group"
            >
              {s.label}
...
function CtaSection() {
  return (
    <section id="contato" className="py-8 px-4">
      <div
        className="max-w-[1200px] mx-auto rounded-2xl p-12 text-center text-white relative overflow-hidden"
      ...
      >
        ...
        <h2
          className="text-[2rem] md:text-[2.4rem] font-normal mb-3 relative"
          style={{ fontFamily: 'var(--font-serif)' }}
        >
          Quer anunciar ou encontrar <em className="text-[#c9a35a]">seu imóvel?</em>
        </h2>
        <p className="text-[0.9rem] text-white/75 mb-8 max-w-[50ch] mx-auto relative">
        ...
        <div className="flex gap-4 justify-center flex-wrap relative">
          <a
            ...
            className="bg-[#c9a35a] text-[#0b1420] rounded-full px-8 py-3 text-[0.72rem] font-bold tracking-[.16em] uppercase transition-all hover:-translate-y-0.5 hover:shadow-xl"
          >
            Falar pelo WhatsApp
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white/15 text-white border border-white/30 rounded-full px-8 py-3 text-[0.72rem] font-bold tracking-[.16em] uppercase transition-all hover:bg-white/25"
          >
            Seguir no Instagram
          </a>
        </div>
