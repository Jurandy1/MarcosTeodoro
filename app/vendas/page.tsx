...
export const metadata: Metadata = {
  ...
  description:
    'Imóveis à venda no litoral de Santa Catarina: Balneário Camboriú, Itapema e Porto Belo. Apartamentos frente-mar, casas em condomínio, coberturas e lançamentos.',
}
...
const properties: Property[] = [
  {
    ...
    title: 'Cobertura frente-mar Barra Sul',
    bedrooms: 4,
    bathrooms: 5,
    parking: 4,
    area: '—',
