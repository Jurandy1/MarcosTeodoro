  ...
  return (
    <footer className="bg-[#0b1420] text-[#a9abaf] text-[0.78rem]">
      ...
      <a
        ...
        className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] w-12 h-12 rounded-full bg-[#25d366] flex items-center justify-center shadow-[0_6px_20px_rgba(0,0,0,.2)] z-50 hover:opacity-90 transition-opacity"
      >
